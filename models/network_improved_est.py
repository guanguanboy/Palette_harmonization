...
class Network(BaseNetwork):
    def __init__(self, unet, beta_schedule, module_name='sr3', **kwargs):
        ...
        if module_name == 'sr3':
            ...
            from .guided_diffusion_modules.unet_modified_with_est_emb import UNet
    ...
    def p_sample(self, y_t, t, clip_denoised=True, y_cond=None, mask=None): #从y_t采样t时刻的重构值
        ...
        out = self.spaced_dpm.p_sample_dp_est(model=self.denoise_fn, x=y_t, t=t, clip_denoised=clip_denoised, denoised_fn=None, cond_fn=None,model_kwargs=model_kwargs)
    ...
    def forward(self, y_0, y_cond=None, mask=None, noise=None): #参数顺序，真实图片y_0，合成图片(条件图片y_cond)以及mask
        ...
        loss = self.spaced_dpm.training_losses_dp_est(self.denoise_fn, y_0, t, model_kwargs=model_kwargs)
        return loss
